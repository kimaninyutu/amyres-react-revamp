    ...
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled 
          ...
          : 'backdrop-blur-md bg-gradient-to-r from-white/90 to-white/70'
      }`}
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="hidden lg:flex space-x-1">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <div className="backdrop-blur-xl bg-white/90 rounded-2xl shadow-2xl border border-white/30 overflow-hidden">
          ...
          <button
            onClick={toggleMenu}
            className="lg:hidden p-3 rounded-xl hover:bg-white/50 transition-all duration-300 hover:shadow-md"
          >
            {isMenuOpen ? 
        ...
        {isMenuOpen && (
          <nav className="lg:hidden pb-6 border-t border-white/30 mt-4 pt-6">
            <div className="backdrop-blur-xl bg-white/80 rounded-2xl p-4 space-y-2">
